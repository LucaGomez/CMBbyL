...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 10 13:00:10 2025
...
def nah_master(cmb_qu, mask, bl=None, nside=512, nlb=12):
    '''
    ...
    '''
    f_qu = nmt.NmtField(mask, cmb_qu, beam=bl, purify_b=True, purify_e=False)
    b = nmt.NmtBin.from_nside_linear(nside, nlb=nlb, is_Dell=False) #nlb=10, \delta_ell ~ 1/fsky
